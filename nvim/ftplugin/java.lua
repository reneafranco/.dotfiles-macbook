...
-- local jdtls_ok, jdtls = pcall(require, 'renea.plugins.nvim-jdtls') -- Actualiza la ruta aquí
...
--
--     --/usr/libexec/java_home -V Eclipse jdtls location
...
--     '-configuration', vim.env.HOME .. '/.local/share/nvim/mason/packages/jdtls/config_mac',  -- Cambia config_linux a config_mac
--     '-data', workspace_dir
--   },
--
...
--
-- config['on_attach'] = function(client, bufnr)
--         -- Aquí puedes agregar cualquier configuración adicional para cuando se adjunta el cliente.
--     end
--
